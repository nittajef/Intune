...
$hash = [ordered]@{
    'V-220697 - Require Windows Enterprise x64' = $V220697
    'V-220698 - TPM Enabled & Ready' = $V220698
    'V-220699 - Use UEFI' = $V220699
    'V-220701-NoChk - Flaw Remediation' = $V220701
    'V-220702 - Use Bitlocker' = $V220702
    'V-220703 - Use Bitlocker Startup PIN' = $V220703
    'V-220704 - Minimum Bitlocker PIN length' = $V220704
    'V-220705-NoChk - Application Allowlist' = $V220705
    'V-220709 - No Alternate OS' = $V220709
    'V-220710-NoChk - Limit Non-system Share Access' = $V220710
    'V-220713 - Limit Backup Operators Members' = $V220713
    'V-220714 - Limit Hyper-V Administrators Members' = $V220714
    'V-220716 - Require Password Expiration' = $V220716
    'V-220717 - System Directories Permissions' = $V220717
    'V-220719 - No SNMP Installed' = $V220719
    'V-220720 - No Simple Tcp/Ip Installed' = $V220720
    'V-220721 - No Telnet Installed' = $V220721
    'V-220722 - No TFTP Installed' = $V220722
    'V-220723 - No Cert Installation Files' = $V220723
    'V-220724 - Use Firewall' = $V220724
    'V-220725-NoChk - Firewall Inbound Exceptions' = $V220725
    'V-220728 - Disable PowerShell V2' = $V220728
    'V-220729 - Disable SMBv1 Protocol' = $V220729
    'V-220730 - Disable SMBv1 Server' = $V220730
    'V-220731 - Disable SMBv1 Client' = $V220731
    'V-220732 - Disable Secondary Logon' = $V220732
    'V-220733-NoChk - Remove Orphaned SIDs' = $V220733
    'V-220734-NoChk - Bluetooth Turned Off Unless Approved' = $V220734
    'V-220735-NoChk - Bluetooth Turned Off When Not in Use' = $V220735
    'V-220736-NoChk - Bluetooth Notify When Device Attempts Connect' = $V220736
    'V-220738-NoChk - Nonpersistent VM Session Limit' = $V220738
    'V-220739 - Configure Account Lockout Duration' = $V220739
    'V-220740 - Configure Failed Logon Attempts' = $V220740
    'V-220741 - Configure Bad Logon Counter Reset' = $V220741
    'V-220742 - Configure Password History' = $V220742
    'V-220743 - Configure Max Password Age' = $V220743
    'V-220744 - Configure Min Password Age' = $V220744
    'V-220745 - Configure Min Password Length' = $V220745
    'V-220746 - Configure Password Complexity' = $V220746
    'V-220748 - Audit Account Logon - Credential Validation - Failure' = $V220748
    'V-220749 - Audit Account Logon - Credential Validation - Success' = $V220749
    'V-220750 - Audit Account Management - Security Group Management - Success' = $V220750
    'V-220751 - Audit Account Management - User Account Management - Failure' = $V220751
    'V-220752 - Audit Account Management - User Account Management - Success' = $V220752
    'V-220753 - Audit Detailed Tracking - PnP Activity - Success' = $V220753
    'V-220754 - Audit Detailed Tracking - Process Creation - Success' = $V220754
    'V-220755 - Audit Logon/Logoff - Account Lockout - Failure' = $V220755
    'V-220756 - Audit Logon/Logoff - Group Membership - Success' = $V220756
    'V-220757 - Audit Logon/Logoff - Logoff - Success' = $V220757
    'V-220758 - Audit Logon/Logoff - Logon - Failure' = $V220758
    'V-220759 - Audit Logon/Logoff - Logon - Success' = $V220759
    'V-220760 - Audit Logon/Logoff - Special Logon - Success' = $V220760
    'V-220761 - Audit Object Access - File Share - Failure' = $V220761
    'V-220762 - Audit Object Access - File Share - Success' = $V220762
    'V-220763 - Audit Object Access - Other Object Access Events - Success' = $V220763
    'V-220764 - Audit Object Access - Other Object Access Events - Failure' = $V220764
    'V-220765 - Audit Object Access - Removable Storage - Failure' = $V220765
    'V-220766 - Audit Object Access - Removable Storage - Success' = $V220766
    'V-220767 - Audit Policy Change - Audit Policy Change - Success' = $V220767
    'V-220768 - Audit Policy Change - Authentication Policy Change - Success' = $V220768
    'V-220769 - Audit Policy Change - Authorization Policy Change - Success' = $V220769
    'V-220770 - Audit Privilege Use - Sensitive Privilege Use - Failure' = $V220770
    'V-220771 - Audit Privilege Use - Sensitive Privilege Use - Success' = $V220771
    'V-220772 - Audit System - IPSec Driver - Failure' = $V220772
    'V-220773 - Audit System - Other System Events - Success' = $V220773
    'V-220774 - Audit System - Other System Events - Failure' = $V220774
    'V-220775 - Audit System - Security State Change - Success' = $V220775
    'V-220776 - Audit System - Security System Extension - Success' = $V220776
    'V-220777 - Audit System - System Integrity - Failure' = $V220777
    'V-220778 - Audit System - System Integrity - Success' = $V220778
    'V-220779 - Configure Application Event Log Size' = $V220779
    'V-220780 - Configure Security Event Log Size' = $V220780
    'V-220781 - Configure System Event Log Size' = $V220781
    'V-220782 - Configure Application Event Log ACL' = $V220782
    'V-220783 - Configure Security Event Log ACL' = $V220783
    'V-220784 - Configure System Event Log ACL' = $V220784
    'V-220786 - Audit Other Policy Change Events - Failure' = $V220786
    'V-220787 - Audit Other Logon/Logoff - Success' = $V220787
    'V-220788 - Audit Other Logon/Logoff - Failure' = $V220788
    'V-220789 - Audit Detailed File Share - Failure' = $V220789
    'V-220790 - Audit MPSSVC Rule-Level Policy Change - Success' = $V220790
    'V-220791 - Audit MPSSVC Rule-Level Policy Change - Failure' = $V220791
}
